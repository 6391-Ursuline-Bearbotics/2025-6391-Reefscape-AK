...
public class VisionIOQuestNav implements VisionIO {
    ...
    private final Transform2d robotToQuest = new Transform2d(Units.inchesToMeters(6), 0.0, new Rotation2d());
    ...
    public void updateInputs(VisionIOInputs inputs) {
        ...
        inputs.poseObservations = new VisionIO.PoseObservation[] {
            new PoseObservation(
                    ...
                    PoseObservationType.QUEST)}; // Observation type
