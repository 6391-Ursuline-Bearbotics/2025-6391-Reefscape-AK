...
public class Climber extends GenericMotionProfiledSubsystem<Climber.State> {
  ...
  public enum State implements TargetState {
    // HOME is climber upright, Prep - Assuming that PREP position is parallel to the x axis, CLIMB
    // is inwards
  ...
  @Getter public final Alert climbedAlert = new Alert("CLIMB COMPLETE", Alert.AlertType.kInfo);
