...
public final class ArmConstants {
  ...
  static {
    ...
    // Motor simulation
    kSubSysConstants.kMotorSimConfig.simMotorModelSupplier = () -> DCMotor.getFalcon500(1);

    // Arm Simulation
    kSubSysConstants.kArmSimConfig.kIsComboSim = true;
    kSubSysConstants.kArmSimConfig.kArmMass = Units.lbsToKilograms(5.5); // Kilograms
    kSubSysConstants.kArmSimConfig.kArmLength = Units.inchesToMeters(12);
    kSubSysConstants.kArmSimConfig.kDefaultArmSetpointDegrees = 90.0;
    kSubSysConstants.kArmSimConfig.kMinAngleDegrees = -45.0;
    kSubSysConstants.kArmSimConfig.kMaxAngleDegrees = 90.0;
